...
def get_isaac_sim_remappings(mode: NvbloxMode, num_cameras: int,
    ...
    for i, name in enumerate(camera_names):
        remappings.append((f'camera_{i}/depth/image', '/depth'))
        remappings.append((f'camera_{i}/depth/camera_info', '/camera_info'))
        remappings.append((f'camera_{i}/color/image', '/input_image'))
        remappings.append((f'camera_{i}/color/camera_info', '/front_stereo_camera/left/camera_info'))
